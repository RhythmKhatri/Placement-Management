...
public class SignUp extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Student's Sign Up");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
         ...
         try
        {
            ...
            u=txtuname.getText();
            p=txtpass.getText();
            check=txtcpass.getText();
            if(check.equals(p))
            {
                q="insert into login values ('"+u+"','"+p+"' ,'"+student+"')" ;
                 st.executeUpdate(q);
        ...
        {
            JOptionPane.showMessageDialog(this,"User Already Exists (Try different username )!!");
        }
